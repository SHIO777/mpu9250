...
covariance   = single(diag([Sigma_angErr*[1;1;1];Sigma_velNED*[1;1;1];Sigma_dAngBias*[1;1;1]].^2));     % .^2は要素単位のべき乗
%% Main Loop
magIndex = 1;
time = 0;
angErr = 0;
