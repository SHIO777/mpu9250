...
########################################
bugfix:2021/09/11: Change the magRange 4912 to 4800 uT.
...
class MPU9250:
    ...
    def get_axis(self):
        ...
        temp = math.sqrt(accel[2] * accel[2] + accel[1] * accel[1])
...
if __name__ == '__main__':
    ...
    while True:
        ...
        重力加速度を求める
        トラ技2019年7月号 p.43
        1G = math.sqrt(g_y**2+g_z*2)
        """
        # g = math.sqrt(accel[1]**2+accel[2]**2)
        # theta = math.degrees(math.atan2(accel[2], accel[1]))
        # print(theta)
        ...
        # print("pitch={}".format(axis[0]))
        # print("yaw={}".format(axis[1]))
        # print("roll={}".format(axis[2]))
